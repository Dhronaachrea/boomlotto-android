...
import com.skilrock.boomlotto.databinding.SheetResultFilterBinding
import com.skilrock.boomlotto.utility.getCurrentDate
import com.skilrock.boomlotto.utility.getPreviousDate
import com.skilrock.boomlotto.viewmodels.ResultFilterViewModel
import kotlinx.coroutines.delay
import kotlinx.coroutines.launch
import java.text.SimpleDateFormat
import java.util.*

class ResultFilterSheet(val callBackSendingSelectedDay:(startDay: String, endDate: String) -> Unit): BottomSheetDialogFragment() {

    private lateinit var resultFilterViewModel: ResultFilterViewModel
    private lateinit var binding: SheetResultFilterBinding
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.sheet_result_filter, container, false)
        setSheetExpanded()
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        resultFilterViewModel = ViewModelProvider(this)[ResultFilterViewModel::class.java]
        binding.viewModelForFilterDateRangePicker = this.resultFilterViewModel
    ...
    private fun setCalenderConstraint(){
        ...
        binding.dateRangePicker.setCalendarListener(object : CalendarListener {
            ...
            override fun onFirstDateSelected(startDate: Calendar) {
                resultFilterViewModel.livedataShowPickedCustomDateForResult.value = "Select Date Range"
            ...
            override fun onDateRangeSelected(startDate: Calendar, endDate: Calendar) {
                ...
                resultFilterViewModel.livedataShowPickedCustomDateForResult.value = ("$strStartDate ${getString(R.string.to)} $strEndDate")
