...
class UpdateProfileViewModel : BaseViewModel() {
    ...
    private val liveDataState   = MutableLiveData<ResponseStatus<ArrayList<StateResponse.Data?>>>()
    ...
    fun callIdVerificationWithdrawalApi(firstName: String, lastName: String, dob: String, nationality: String, docName: String,
                                        docValue: String, expiryDate: String, filePathList: ArrayList<String>) {
        liveDataLoader.postValue(true)

        viewModelScope.launch(Dispatchers.IO + coroutineExceptionHandler) {
            val verificationRequestParams = verificationRequestParams(firstName, lastName, dob, nationality, docName, docValue, expiryDate, filePathList.size)
    ...
    private fun verificationRequestParams(firstName: String, lastName: String, dob: String, nationality: String,
                                          docName: String, docValue: String, expiryDate: String, docCount: Int): HashMap<String, RequestBody> {
